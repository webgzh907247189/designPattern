...
//个人规划目标
1. 以满足公司业务需求为基础，继续提升个人知识技能
2. 提升个人知识技能主要从两大块  
	前端(vue 进入其底层,熟悉其代码实现,理解原理,每个精妙的部分尝试自己实现一个简单的demo; 继续查漏补缺js基本功 包括 设计模式,基础语法部分)   
	node(继续读完 深入浅出node,尝试去理解底层,深入理解koa框架,每个精妙的部分尝试自己实现一个简单的demo )
	附加 在服务器方面继续尝试( 部署+运维 ),继续了解整个链路流程&知识 (RPC API Gateway F5)
3. 保持对新技术的追求，以及视野。经常关注行业内的新技术