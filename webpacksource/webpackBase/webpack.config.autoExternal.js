...
const AutoExternal = require('./myPlugin/autoExternal')
...
module.exports = {
    ...
    mode: 'development',
    devtool: false,
    entry: './src/autoExternalIndex.js',
    output: {
        path: path.resolve(__dirname, 'distauto'),
    ...
    plugins: [
        ...
        new HtmlWebpackplugin({
            template: './index.aotoExternal.html',
        ...
        new AutoExternal({
            vue: {
                variable: 'Vue',
                url: 'https://cdn.bootcdn.net/ajax/libs/vue/2.6.10/vue.js',
            }
        }),
    ]
}